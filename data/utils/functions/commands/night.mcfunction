...
execute if score localtime Time matches ..12999 run function utils:commands/set_time with storage core:commands
...
execute if score localtime Time matches 13000.. run function utils:commands/set_time with storage core:commands
