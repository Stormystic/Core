...
execute as @e[type=minecraft:item_display,tag=TELE_PLACED,tag=UPDATED_TELE] at @s run function teleporters:main_update
execute as @e[type=minecraft:item_display,tag=TELE_INIT] at @s run function teleporters:main_init

execute as @e[type=minecraft:item_display,tag=TELE_PLACED,tag=UPDATING_TELE] at @s run tag @s remove UPDATING_TELE
execute as @e[type=minecraft:item_display,tag=TELE_PLACED,tag=!UPDATED_TELE] at @s run function teleporters:update_to_new_format
