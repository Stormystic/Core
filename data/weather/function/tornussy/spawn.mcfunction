...
execute as @e[type=armor_stand,sort=nearest,limit=1,tag=tornado_spawning] run attribute @s minecraft:gravity base set 0.1
...
execute as @e[type=armor_stand,sort=nearest,limit=1,tag=tornado_spawning] run attribute @s minecraft:scale base set 3
