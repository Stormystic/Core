...
execute rotated ~ 0 run summon marker ^ ^ ^0.66 {Tags:["tornadoang"]}

execute unless entity @s[tag=INITIAL_SPAWN] facing entity @e[gamemode=!creative,gamemode=!spectator,type=#weather:tornado_valid,predicate=weather:can_see_sky,tag=!tornado,sort=nearest,distance=..60,limit=1] feet rotated ~ 0 positioned ^ ^ ^0.66 run teleport @e[sort=nearest,limit=1,tag=tornadoang] ~ ~ ~ ~ ~
execute if entity @s[tag=INITIAL_SPAWN] if entity @a[predicate=weather:can_see_sky,sort=nearest,distance=..24,limit=1] run tag @s remove INITIAL_SPAWN
#	execute facing entity @a[predicate=weather:can_see_sky,sort=nearest,distance=..12,limit=1] feet rotated ~ 0 positioned ^ ^ ^0.88 run teleport @e[sort=nearest,limit=1,tag=tornadoang] ~ ~ ~ ~ ~
...
execute positioned ~-6.5 ~ ~-6.5 as @e[type=#weather:tornado_valid,predicate=weather:can_see_sky,dx=12,dy=28,dz=12] at @s run function weather:tornussy/tick_target 

#execute positioned ~ ~10 ~ at @e[dy=5,type=#weather:tornado_valid,predicate=weather:can_see_sky,sort=nearest,tag=!tornado,distance=..10] run damage @e[type=#weather:tornado_valid,predicate=weather:can_see_sky,sort=nearest,tag=!tornado,limit=1] 0.1 minecraft:wind_charge at ~ ~-1 ~
#execute positioned ~ ~9 ~ at @e[type=#weather:tornado_valid,predicate=weather:can_see_sky,sort=nearest,tag=!tornado,distance=..8] run damage @e[type=#weather:tornado_valid,predicate=weather:can_see_sky,sort=nearest,tag=!tornado,limit=1] 0.15 minecraft:wind_charge at ~ ~-1 ~
#execute positioned ~ ~4 ~ at @e[dy=-4,type=#weather:tornado_valid,predicate=weather:can_see_sky,sort=nearest,tag=!tornado,distance=..5] run damage @e[type=#weather:tornado_valid,predicate=weather:can_see_sky,sort=nearest,tag=!tornado,limit=1] 0.25 minecraft:wind_charge at ~ ~-1 ~
#execute positioned ~ ~10 ~ at @e[dy=4,type=#weather:tornado_valid,predicate=weather:can_see_sky,sort=nearest,tag=!tornado,distance=..5] run effect give @e[type=#weather:tornado_valid,predicate=weather:can_see_sky,sort=nearest,tag=!tornado,limit=1] minecraft:levitation 1 2 true
#execute positioned ~ ~2 ~ at @e[type=#weather:tornado_valid,predicate=weather:can_see_sky,sort=nearest,tag=!tornado,distance=..2.5] run effect give @e[type=#weather:tornado_valid,predicate=weather:can_see_sky,sort=nearest,tag=!tornado,limit=1] minecraft:levitation 1 12 true