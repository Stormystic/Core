...
execute if entity @s[tag=1] run data modify storage secret_page:data 1_hover set value {text:"Hotsauce",extra:[{text:" ✔\n",color:"green"},{text:"Spawn, Mineshaft\n",color:"light_purple",italic:1b},{text:"\n[Click to teleport]",color:"green"}],color:"aqua"}
execute unless entity @s[tag=1] run data modify storage secret_page:data 1_color set value "red"
execute unless entity @s[tag=1] run data modify storage secret_page:data 1_hover set value {text:"Hotsauce",extra:[{text:" 🔒\n",color:"red"},{text:"Spawn, Mineshaft",color:"light_purple",italic:1b}],color:"aqua"}

execute if entity @s[tag=2] run data modify storage secret_page:data 2_color set value "green"
execute if entity @s[tag=2] run data modify storage secret_page:data 2_hover set value {text:"The Water Room",extra:[{text:" ✔\n",color:"green"},{text:"Spawn, Outskirts\n",color:"light_purple",italic:1b},{text:"\n[Click to teleport]",color:"green"}],color:"aqua"}
execute unless entity @s[tag=2] run data modify storage secret_page:data 2_color set value "red"
execute unless entity @s[tag=2] run data modify storage secret_page:data 2_hover set value {text:"The Water Room",extra:[{text:" 🔒\n",color:"red"},{text:"Spawn, Outskirts",color:"light_purple",italic:1b}],color:"aqua"}

execute if entity @s[tag=3] run data modify storage secret_page:data 3_color set value "green"
execute if entity @s[tag=3] run data modify storage secret_page:data 3_hover set value {text:"The Earth Room",extra:[{text:" ✔\n",color:"green"},{text:"Spawn, Outskirts\n",color:"light_purple",italic:1b},{text:"\n[Click to teleport]",color:"green"}],color:"aqua"}
execute unless entity @s[tag=3] run data modify storage secret_page:data 3_color set value "red"
execute unless entity @s[tag=3] run data modify storage secret_page:data 3_hover set value {text:"The Earth Room",extra:[{text:" 🔒\n",color:"red"},{text:"Spawn, Outskirts",color:"light_purple",italic:1b}],color:"aqua"}

execute if entity @s[tag=4] run data modify storage secret_page:data 4_color set value "green"
execute if entity @s[tag=4] run data modify storage secret_page:data 4_hover set value {text:"The Fire Room",extra:[{text:" ✔\n",color:"green"},{text:"Spawn, Outskirts\n",color:"light_purple",italic:1b},{text:"\n[Click to teleport]",color:"green"}],color:"aqua"}
execute unless entity @s[tag=4] run data modify storage secret_page:data 4_color set value "red"
execute unless entity @s[tag=4] run data modify storage secret_page:data 4_hover set value {text:"The Fire Room",extra:[{text:" 🔒\n",color:"red"},{text:"Spawn, Outskirts",color:"light_purple",italic:1b}],color:"aqua"}

execute if entity @s[tag=5] run data modify storage secret_page:data 5_color set value "green"
execute if entity @s[tag=5] run data modify storage secret_page:data 5_hover set value {text:"The Wind Room",extra:[{text:" ✔\n",color:"green"},{text:"Spawn, Sky\n",color:"light_purple",italic:1b},{text:"\n[Click to teleport]",color:"green"}],color:"aqua"}
execute unless entity @s[tag=5] run data modify storage secret_page:data 5_color set value "red"
execute unless entity @s[tag=5] run data modify storage secret_page:data 5_hover set value {text:"The Wind Room",extra:[{text:" 🔒\n",color:"red"},{text:"Spawn, Outskirts",color:"light_purple",italic:1b}],color:"aqua"}

execute if entity @s[tag=6] run data modify storage secret_page:data 6_color set value "green"
execute if entity @s[tag=6] run data modify storage secret_page:data 6_hover set value {text:"Up!",extra:[{text:" ✔\n",color:"green"},{text:"Spawn, Sky\n",color:"light_purple",italic:1b},{text:"\n[Click to teleport]",color:"green"}],color:"aqua"}
execute unless entity @s[tag=6] run data modify storage secret_page:data 6_color set value "red"
execute unless entity @s[tag=6] run data modify storage secret_page:data 6_hover set value {text:"Up!",extra:[{text:" 🔒\n",color:"red"},{text:"Spawn, Outskirts",color:"light_purple",italic:1b}],color:"aqua"}

execute if entity @s[tag=7] run data modify storage secret_page:data 7_color set value "green"
execute if entity @s[tag=7] run data modify storage secret_page:data 7_hover set value {text:"The Flaming Cake",extra:[{text:" ✔\n",color:"green"},{text:"Spawn, Underground\n",color:"light_purple",italic:1b},{text:"\n[Click to teleport]",color:"green"}],color:"aqua"}
execute unless entity @s[tag=7] run data modify storage secret_page:data 7_color set value "red"
execute unless entity @s[tag=7] run data modify storage secret_page:data 7_hover set value {text:"The Flaming Cake",extra:[{text:" 🔒\n",color:"red"},{text:"Spawn, Outskirts",color:"light_purple",italic:1b}],color:"aqua"}

execute if entity @s[tag=8] run data modify storage secret_page:data 8_color set value "green"
execute if entity @s[tag=8] run data modify storage secret_page:data 8_hover set value {text:"Rareware",extra:[{text:" ✔\n",color:"green"},{text:"Spawn, Underground\n",color:"light_purple",italic:1b},{text:"\n[Click to teleport]",color:"green"}],color:"aqua"}
...
execute if entity @s[tag=16] run data modify storage secret_page:data 16_hover set value {text:"End of the Road",extra:[{text:" ✔\n",color:"green"},{text:"Spawn, Mineshaft\n",color:"light_purple",italic:1b},{text:"\n[Click to teleport]",color:"green"}],color:"aqua"}
execute unless entity @s[tag=16] run data modify storage secret_page:data 16_color set value "red"
execute unless entity @s[tag=16] run data modify storage secret_page:data 16_hover set value {text:"End of the Road",extra:[{text:" 🔒\n",color:"red"},{text:"Spawn, Mineshaft",color:"light_purple",italic:1b}],color:"aqua"}

execute if entity @s[tag=17] run data modify storage secret_page:data 17_color set value "green"
execute if entity @s[tag=17] run data modify storage secret_page:data 17_hover set value {text:"Forgotten Legacy",extra:[{text:" ✔\n",color:"green"},{text:"Spawn, Mineshaft\n",color:"light_purple",italic:1b},{text:"\n[Click to teleport]",color:"green"}],color:"aqua"}
execute unless entity @s[tag=17] run data modify storage secret_page:data 17_color set value "red"
execute unless entity @s[tag=17] run data modify storage secret_page:data 17_hover set value {text:"Forgotten Legacy",extra:[{text:" 🔒\n",color:"red"},{text:"Spawn, Sky",color:"light_purple",italic:1b}],color:"aqua"}

execute if entity @s[tag=18] run data modify storage secret_page:data 18_color set value "green"
execute if entity @s[tag=18] run data modify storage secret_page:data 18_hover set value {text:"Evening Ascent",extra:[{text:" ✔\n",color:"green"},{text:"Spawn, Sky\n",color:"light_purple",italic:1b},{text:"\n[Click to teleport]",color:"green"}],color:"aqua"}
execute unless entity @s[tag=18] run data modify storage secret_page:data 18_color set value "red"
execute unless entity @s[tag=18] run data modify storage secret_page:data 18_hover set value {text:"Evening Ascent",extra:[{text:" 🔒\n",color:"red"},{text:"Spawn, Sky",color:"light_purple",italic:1b}],color:"aqua"}

execute if entity @s[tag=19] run data modify storage secret_page:data 19_color set value "green"
execute if entity @s[tag=19] run data modify storage secret_page:data 19_hover set value {text:"Dank Depths",extra:[{text:" ✔\n",color:"green"},{text:"Spawn, Surface\n",color:"light_purple",italic:1b},{text:"\n[Click to teleport]",color:"green"}],color:"aqua"}
...
execute unless entity @s[tag=21] run data modify storage secret_page:data 21_hover set value {text:"Bullseye",extra:[{text:" 🔒\n",color:"red"},{text:"Spawn, Surface",color:"light_purple",italic:1b}],color:"aqua"}


execute if entity @s[tag=22] run data modify storage secret_page:data 22_color set value "green"
execute if entity @s[tag=22] run data modify storage secret_page:data 22_hover set value {text:"For the Sussiest",extra:[{text:" ✔\n",color:"green"},{text:"Spawn, Mineshaft\n",color:"light_purple",italic:1b},{text:"\n[Click to teleport]",color:"green"}],color:"aqua"}
execute unless entity @s[tag=22] run data modify storage secret_page:data 22_color set value "red"
execute unless entity @s[tag=22] run data modify storage secret_page:data 22_hover set value {text:"For the Sussiest",extra:[{text:" 🔒\n",color:"red"},{text:"Spawn, Mineshaft",color:"light_purple",italic:1b}],color:"aqua"}

execute if entity @s[tag=23] run data modify storage secret_page:data 23_color set value "green"
execute if entity @s[tag=23] run data modify storage secret_page:data 23_hover set value {text:"A Great Lie",extra:[{text:" ✔\n",color:"green"},{text:"Spawn, Outskirts\n",color:"light_purple",italic:1b},{text:"\n[Click to teleport]",color:"green"}],color:"aqua"}
...
execute if entity @s[tag=26] run data modify storage secret_page:data 26_hover set value {text:"Bottom of the Well",extra:[{text:" ✔\n",color:"green"},{text:"Spawn, Surface\n",color:"light_purple",italic:1b},{text:"\n[Click to teleport]",color:"green"}],color:"aqua"}
execute unless entity @s[tag=26] run data modify storage secret_page:data 26_color set value "red"
execute unless entity @s[tag=26] run data modify storage secret_page:data 26_hover set value {text:"Bottom of the Well",extra:[{text:" 🔒\n",color:"red"},{text:"Spawn, Surface",color:"light_purple",italic:1b}],color:"aqua"}
...
execute if entity @s[tag=28] run data modify storage secret_page:data 28_hover set value {text:"Fruity!",extra:[{text:" ✔\n",color:"green"},{text:"Spawn, Dome\n",color:"light_purple",italic:1b},{text:"\n[Click to teleport]",color:"green"}],color:"aqua"}
execute unless entity @s[tag=28] run data modify storage secret_page:data 28_color set value "red"
execute unless entity @s[tag=28] run data modify storage secret_page:data 28_hover set value {text:"Fruity!",extra:[{text:" 🔒\n",color:"red"},{text:"Spawn, Dome",color:"light_purple",italic:1b}],color:"aqua"}
...
execute unless entity @s[tag=41] run data modify storage secret_page:data 41_hover set value {text:"Coming in a future release",color:"dark_red"}
...
execute unless entity @s[tag=42] run data modify storage secret_page:data 42_hover set value {text:"Coming in a future release",color:"dark_red"}
...
execute unless entity @s[tag=43] run data modify storage secret_page:data 43_hover set value {text:"Coming in a future release",color:"dark_red"}
...
execute unless entity @s[tag=44] run data modify storage secret_page:data 44_hover set value {text:"Coming in a future release",color:"dark_red"}
...
execute unless entity @s[tag=45] run data modify storage secret_page:data 45_hover set value {text:"Coming in a future release",color:"dark_red"}
...
execute unless entity @s[tag=46] run data modify storage secret_page:data 46_hover set value {text:"Coming in a future release",color:"dark_red"}
...
execute unless entity @s[tag=47] run data modify storage secret_page:data 47_hover set value {text:"Coming in a future release",color:"dark_red"}
...
execute unless entity @s[tag=48] run data modify storage secret_page:data 48_hover set value {text:"Coming in a future release",color:"dark_red"}
...
execute unless entity @s[tag=49] run data modify storage secret_page:data 49_hover set value {text:"Coming in a future release",color:"dark_red"}
...
execute unless entity @s[tag=50] run data modify storage secret_page:data 50_hover set value {text:"Coming in a future release",color:"dark_red"}
...
execute unless entity @s[tag=51] run data modify storage secret_page:data 51_hover set value {text:"Coming in a future release",color:"dark_red"}
...
execute unless entity @s[tag=52] run data modify storage secret_page:data 52_hover set value {text:"Coming in a future release",color:"dark_red"}
...
execute unless entity @s[tag=53] run data modify storage secret_page:data 53_hover set value {text:"Coming in a future release",color:"dark_red"}
...
execute unless entity @s[tag=54] run data modify storage secret_page:data 54_hover set value {text:"Coming in a future release",color:"dark_red"}
...
execute unless entity @s[tag=55] run data modify storage secret_page:data 55_hover set value {text:"Coming in a future release",color:"dark_red"}
...
execute unless entity @s[tag=56] run data modify storage secret_page:data 56_hover set value {text:"Coming in a future release",color:"dark_red"}
...
execute unless entity @s[tag=57] run data modify storage secret_page:data 57_hover set value {text:"Coming in a future release",color:"dark_red"}
...
execute unless entity @s[tag=58] run data modify storage secret_page:data 58_hover set value {text:"Coming in a future release",color:"dark_red"}
...
execute unless entity @s[tag=59] run data modify storage secret_page:data 59_hover set value {text:"Coming in a future release",color:"dark_red"}
...
execute unless entity @s[tag=60] run data modify storage secret_page:data 60_hover set value {text:"Coming in a future release",color:"dark_red"}
...
execute unless entity @s[tag=61] run data modify storage secret_page:data 61_hover set value {text:"Coming in a future release",color:"dark_red"}
...
execute unless entity @s[tag=62] run data modify storage secret_page:data 62_hover set value {text:"Coming in a future release",color:"dark_red"}
...
execute unless entity @s[tag=63] run data modify storage secret_page:data 63_hover set value {text:"Coming in a future release",color:"dark_red"}
...
execute unless entity @s[tag=64] run data modify storage secret_page:data 64_hover set value {text:"Coming in a future release",color:"dark_red"}