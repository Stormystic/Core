scoreboard players set #Scale dummy 10000
...
scoreboard players operation #RoundedY dummy *= #Scale dummy
scoreboard players operation #RoundedZ dummy *= #Scale dummy
execute store result score X dummy run data get entity @s Pos[0] 10000
execute store result score Y dummy run data get entity @s Pos[1] 10000
execute store result score Z dummy run data get entity @s Pos[2] 10000
