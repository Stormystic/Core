...
execute as @a if score @s[team=!1,team=!2,team=!3,team=!4] warp matches -1 run scoreboard players reset @s warp

execute as @a if score @s[team=!5,team=!] warp matches -1 run dialog show @s core:warps_creative
execute as @a if score @s[team=!5,team=!] warp matches -1 run scoreboard players reset @s warp
