...
execute store result entity @e[type=minecraft:armor_stand,tag=SIT_REF,sort=nearest,limit=1] Motion[0] double 1.0 run data get entity @s Motion[0] 4.0
execute store result entity @e[type=minecraft:armor_stand,tag=SIT_REF,sort=nearest,limit=1] Motion[1] double 1.0 run data get entity @s Motion[1] 1.0
execute store result entity @e[type=minecraft:armor_stand,tag=SIT_REF,sort=nearest,limit=1] Motion[2] double 1.0 run data get entity @s Motion[2] 4.0
