...
#execute as @s at @s run teleport @e[sort=nearest,limit=1,tag=tornadocalc] ~.01 ~.01 ~.01
...
execute as @s at @s run kill @e[sort=nearest,limit=1,tag=tornadocalc]
execute as @s at @s store result storage minecraft:trailmacro tx double 0.00001 run data get entity @s Pos[0] 100000
execute as @s at @s store result storage minecraft:trailmacro ty double 0.00001 run data get entity @s Pos[1] 100000
execute as @s at @s store result storage minecraft:trailmacro tz double 0.00001 run data get entity @s Pos[2] 100000
