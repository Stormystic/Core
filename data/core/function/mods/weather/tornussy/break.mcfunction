...
execute if entity @s[tag=BREAK_VALID] if score #rng dummy matches 75..100 at @e[type=marker,sort=nearest,limit=1,tag=tornbreak] run function core:mods/weather/tornussy/break_weak
execute if entity @s[tag=BREAK_VALID] if score #rng dummy matches 35..74 at @e[type=marker,sort=nearest,limit=1,tag=tornbreak] run function core:mods/weather/tornussy/break_medium
execute if entity @s[tag=BREAK_VALID] if score #rng dummy matches 0..34 at @e[type=marker,sort=nearest,limit=1,tag=tornbreak] run function core:mods/weather/tornussy/break_strong
