...
execute as @s at @s facing entity @a[predicate=core:can_see_sky,sort=nearest,distance=..40,limit=1] feet rotated ~ 0 positioned ^ ^ ^0.75 run teleport @e[sort=nearest,limit=1,tag=tornadoang] ~ ~ ~ ~ ~
