...
execute as @s at @s facing entity @e[type=#core:tornado_valid,predicate=core:can_see_sky,predicate=core:above_sea_level,tag=!tornado,sort=nearest,distance=..60,limit=1] feet rotated ~ 0 positioned ^ ^ ^0.75 run teleport @e[sort=nearest,limit=1,tag=tornadoang] ~ ~ ~ ~ ~
...
execute as @s at @s positioned ~ ~15 ~ at @e[dy=4type=#core:tornado_valid,predicate=core:can_see_sky,predicate=core:above_sea_level,sort=nearest,tag=!tornado,distance=..10] run damage @e[type=#core:tornado_valid,predicate=core:can_see_sky,predicate=core:above_sea_level,sort=nearest,tag=!tornado,limit=1] 0.1 minecraft:wind_charge at ~ ~-1 ~
execute as @s at @s positioned ~ ~9 ~ at @e[dy=6,type=#core:tornado_valid,predicate=core:can_see_sky,predicate=core:above_sea_level,sort=nearest,tag=!tornado,distance=..8] run damage @e[type=#core:tornado_valid,predicate=core:can_see_sky,predicate=core:above_sea_level,sort=nearest,tag=!tornado,limit=1] 0.15 minecraft:wind_charge at ~ ~-1 ~
execute as @s at @s positioned ~ ~3 ~ at @e[dy=6type=#core:tornado_valid,predicate=core:can_see_sky,predicate=core:above_sea_level,sort=nearest,tag=!tornado,distance=..5] run damage @e[type=#core:tornado_valid,predicate=core:can_see_sky,predicate=core:above_sea_level,sort=nearest,tag=!tornado,limit=1] 0.25 minecraft:wind_charge at ~ ~-1 ~
execute as @s at @s positioned ~ ~2 ~ at @e[type=#core:tornado_valid,predicate=core:can_see_sky,predicate=core:above_sea_level,sort=nearest,tag=!tornado,distance=..2.5] run effect give @e[type=#core:tornado_valid,predicate=core:can_see_sky,predicate=core:above_sea_level,sort=nearest,tag=!tornado,limit=1] minecraft:levitation 1 12 true
execute as @s at @s positioned ~ ~14 ~ at @e[dy=3,type=#core:tornado_valid,predicate=core:can_see_sky,predicate=core:above_sea_level,sort=nearest,tag=!tornado,distance=..4] run effect give @e[type=#core:tornado_valid,predicate=core:can_see_sky,predicate=core:above_sea_level,sort=nearest,tag=!tornado,limit=1] minecraft:levitation 1 2 true
