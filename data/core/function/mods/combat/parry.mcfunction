...
execute as @a unless items entity @s weapon.offhand minecraft:shield if items entity @s weapon.mainhand #minecraft:swords[!minecraft:blocks_attacks] run function core:mods/combat/set_parry
...
execute as @a if items entity @s weapon.offhand minecraft:shield if items entity @s weapon.mainhand #minecraft:swords[minecraft:blocks_attacks] run minecraft:item modify entity @s weapon.mainhand core:parry/remove
