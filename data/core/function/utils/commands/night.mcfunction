...
# Night occurs in the middle of the daylight cycle at tick 13000, rather than at the beginning of it (0). Advancing to night doesn't necessarily mean you have to advance the day count, as if it is still early in the current day you can simply advance to that night rather than skipping an entire day to reach the next night; some additional logic was needed for this to work
