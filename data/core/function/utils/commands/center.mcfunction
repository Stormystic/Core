...
# This means if you used something like tp @s ~0.5 ~ ~0.5 it would work - but if the player is moving at all they will immediately move off center after the teleport
