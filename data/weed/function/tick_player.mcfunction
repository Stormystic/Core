...
execute if entity @s[tag=PUFFNAJOIN] if score @s weed matches 51..99 at @s run title @s actionbar {"bold":true,"color":"red","score":{"name":"@p","objective":"weed"}}
execute if entity @s[tag=PUFFNAJOIN] if score @s weed matches 36..50 at @s run title @s actionbar {"bold":true,"color":"gold","score":{"name":"@p","objective":"weed"}}
execute if entity @s[tag=PUFFNAJOIN] if score @s weed matches 26..35 at @s run title @s actionbar {"bold":true,"color":"yellow","score":{"name":"@p","objective":"weed"}}
execute if entity @s[tag=PUFFNAJOIN] if score @s weed matches 21..25 at @s run title @s actionbar {"bold":true,"color":"green","score":{"name":"@p","objective":"weed"}}
execute if entity @s[tag=PUFFNAJOIN] if score @s weed matches 16..20 at @s run title @s actionbar {"bold":true,"color":"dark_green","score":{"name":"@p","objective":"weed"}}
execute if entity @s[tag=PUFFNAJOIN] if score @s weed matches 11..15 at @s run title @s actionbar {"bold":true,"color":"dark_aqua","score":{"name":"@p","objective":"weed"}}
...
execute if entity @s[tag=BLOWNJOINT] if score @s weed matches 36..50 run title @s actionbar {"bold":true,"color":"gold","text":"Large Hit"}
...
execute if entity @s[tag=BLOWNJOINT] if score @s weed matches 21..25 run title @s actionbar {"bold":true,"color":"green","text":"Great Hit"}
execute if entity @s[tag=BLOWNJOINT] if score @s weed matches 16..20 run title @s actionbar {"bold":true,"color":"dark_green","text":"Okay Hit"}
